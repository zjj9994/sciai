...
<img src="docs/images/logo.svg" width="190" alt="sciai logo — an atomic core unified with an eight-node science network"/>

# sciai

**A unified, domain-extensible foundation for AI for Science** ·
**统一、可领域扩展的科学智能（AI for Science）基础框架**
